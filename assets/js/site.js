...
var aapiSlides = [
    ...
    function() { // 39
      aapiVis.setTitle("Conclusion");
      aapiVis.setMessage('This concludes the guided data visualization. To explore the data series presented previously, and additional data series measured by percentage of ethnic group, click on the data series names in the legend below the chart. You can also scroll on the graph to zoom in and out and drag it to pan around the horizontal axis. Thanks for making it this far! I\'d love to hear your feedback, especially critiques and suggestions for improvement, and you can email me at <a href="mailto:ethanli@stanford.edu">ethanli@stanford.edu</a>.');
